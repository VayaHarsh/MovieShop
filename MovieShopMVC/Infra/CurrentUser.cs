...
namespace MovieShopMVC.Infra
{
    public class CurrentUser : ICurrentUser
    {
        ...
        public string Email => _contextAccessor.HttpContext.User.Claims.FirstOrDefault(c => c.Type ==
        ClaimTypes.Email).Value;

        //public string ProfilePictureUrl => throw new NotImplementedException();

        public string FullName => _contextAccessor.HttpContext.User.Claims.FirstOrDefault(c => c.Type == 
        ClaimTypes.GivenName).Value + " " + _contextAccessor.HttpContext.User.Claims.FirstOrDefault(c => c.Type ==
